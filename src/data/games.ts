...
export const games: Game[] = [
  // ── THURSDAY ──
  {
    ...
    story: "Pittsburgh's defense has been elite all season at 8-2, while Cleveland at 2-8 doesn't have the offense to keep up. Thursday games tend to be sloppy.",
    confidence: 72,
    pick: "away",
    scoring: "low",
    factors: ["Elite defense", "Thursday slop"],
    awayPlayers: [
  ...
  // ── SUNDAY EARLY ──
  {
    ...
    story: "Dallas is starting a backup QB and has lost five straight. Washington's rookie Jayden Daniels has been one of the best stories in football this year.",
    confidence: 88,
    pick: "home",
    scoring: "moderate",
    factors: ["Backup QB", "Rookie star"],
    awayPlayers: [
  ...
  },
  {
    ...
    story: "Minnesota is 8-2 with a defense that shuts down young QBs. Chicago's rookie Caleb Williams makes mistakes under pressure — and Minnesota brings a lot of it.",
    confidence: 75,
    pick: "away",
    scoring: "low",
    factors: ["Top-5 defense", "Rookie struggles"],
    awayPlayers: [
  ...
  },
  {
    ...
    story: "Houston is 7-4 and the best team in their division. Tennessee is 2-8 and rebuilding with a young quarterback who's still developing.",
    confidence: 85,
    pick: "home",
    scoring: "moderate",
    factors: ["Division leader", "Star QB edge"],
    awayPlayers: [
  ...
  },
  {
    ...
    story: "Tua is healthy again and Miami's offense is one of the most explosive in football. New England is in full rebuild mode with a rookie QB who doesn't have much help.",
    confidence: 86,
    pick: "home",
    scoring: "high",
    factors: ["Tua healthy", "Speed mismatch"],
    awayPlayers: [
  ...
  },
  {
    ...
    story: "Baker Mayfield is having a career year and Tampa's offense has been tough to stop. The Giants have been one of the worst teams on both sides of the ball.",
    confidence: 84,
    pick: "away",
    scoring: "moderate",
    factors: ["Career-year QB", "Talent gap"],
    awayPlayers: [
  ...
  },
  {
    ...
    story: "The Chiefs are 9-1 with the best QB in football. Carolina is 2-8 and has been the worst team in the NFL for most of the season.",
    confidence: 92,
    pick: "home",
    scoring: "moderate",
    factors: ["Mahomes factor", "Huge talent gap"],
    awayPlayers: [
  ...
  },
  {
    ...
    story: "Detroit is 9-1 and their offense has been putting up 30+ regularly at home. Indianapolis fights hard but doesn't have the firepower to match score-for-score.",
    confidence: 78,
    pick: "home",
    scoring: "high",
    factors: ["Explosive offense", "Home dominance"],
    awayPlayers: [
  ...
  // ── SUNDAY AFTERNOON ──
  {
    ...
    story: "Two of the best teams in football — KC is 9-1 and Buffalo is 9-2. Josh Allen is playing at an MVP level, but you can never count out Mahomes.",
    confidence: 52,
    pick: "toss-up",
    scoring: "high",
    factors: ["MVP duel", "Home edge"],
    awayPlayers: [
  ...
  },
  {
    ...
    story: "A playoff rematch where both offenses are explosive. Green Bay is young and improving fast, while San Francisco is dealing with injuries but still loaded with talent.",
    confidence: 55,
    pick: "toss-up",
    scoring: "high",
    factors: ["Playoff rematch", "Injury watch"],
    awayPlayers: [
  ...
  },
  {
    ...
    story: "Denver has a strong defense and their rookie QB Bo Nix has been smart and steady. Las Vegas is 2-8 and going nowhere this season.",
    confidence: 74,
    pick: "away",
    scoring: "low",
    factors: ["Strong defense", "Smart rookie QB"],
    awayPlayers: [
  ...
  },
  {
    ...
    story: "Both teams are around .500 with inconsistent QBs who are capable of great games and terrible ones. Home field gives Arizona a tiny edge.",
    confidence: 50,
    pick: "toss-up",
    scoring: "moderate",
    factors: ["Both inconsistent", "Dual-threat QBs"],
    awayPlayers: [
  ...
  },
  {
    ...
    story: "Baltimore has one of the most dangerous offenses in football with Lamar Jackson and Derrick Henry. The Chargers are tough and disciplined, but Baltimore has more weapons.",
    confidence: 65,
    pick: "away",
    scoring: "high",
    factors: ["MVP candidate", "Run game dominant"],
    awayPlayers: [
  ...
  // ── SUNDAY NIGHT ──
  {
    ...
    story: "Philly has won 7 straight and Saquon Barkley is having a historic rushing season. The Rams' defense has been gutted by injuries and can't stop the run.",
    confidence: 82,
    pick: "away",
    scoring: "moderate",
    factors: ["Historic run game", "Injured defense"],
    awayPlayers: [
  ...
  // ── MONDAY NIGHT ──
  {
    ...
    story: "Two of the most talented offenses in football. Baltimore has a historically good rushing attack, while Cincinnati's passing game with Burrow and Chase is equally dangerous.",
    confidence: 62,
    pick: "away",
    scoring: "high",
    factors: ["Historic rushing", "Primetime showdown"],
    awayPlayers: [
