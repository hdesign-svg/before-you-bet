    ...
    <main className={s.gridView}>
      ...
      <header className={s.header}>
        <div className={s.headerTop}>
          ...
          >
            {/* Sun icon */}
            <svg className={`${s.themeIcon} ${theme === "light" ? s.themeIconActive : ""}`} width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
            ...
            {/* Moon icon */}
            <svg className={`${s.themeIcon} ${theme === "dark" ? s.themeIconActive : ""}`} width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
